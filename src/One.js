...
const Header=()=>{
    let stick={position: "sticky",
               top: 0}
    return(
        <header className="text-gray-500 bg-gray-900 body-font" style={stick}>
    ...
    return(
        ...
        <div class="container px-5 py-6 mx-auto">
            ...
            <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                <h2 class="text-sm title-font text-gray-600 tracking-widest">BRAND NAME</h2>
                ...
                <div class="flex ml-6 items-center">
                    ...
                    <div class="relative">
                    <select class="rounded border border-gray-700 bg-gray-800 appearance-none py-2 focus:outline-none focus:border-indigo-500 text-white pl-3 pr-10">
                        <option>SM</option>
                        <option>M</option>
                        <option>L</option>
                        <option>XL</option>
